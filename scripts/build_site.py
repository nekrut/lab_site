...
OUT = _os.environ.get('SITE_OUT', _os.path.join(REPO, 'docs'))
DATA_DIR = _os.environ.get('DATA_DIR', _os.path.join(REPO, 'scripts', 'data'))
ASSETS = _os.path.join(REPO, 'assets')
_os.makedirs(OUT, exist_ok=True)

import re, urllib.request, os, unicodedata
CV = open(os.environ.get('CV_MD', '/home/anton/git/CV/vitae.md')).read()
CUR_YEAR = 2026
...
CACHE = os.path.join(DATA_DIR, 'icite_cache.json')
try:
...
KUI_FILE = os.path.join(DATA_DIR, 'kui_stats.json')
...
<div class="cgrid" id="cg"></div></section>
...
if os.environ.get('PREVIEWS'): write('a-terminal.html', A)
if os.environ.get('PREVIEWS'): write('b-industrial.html', B)
...
<meta name="description" content="anLab — the Nekrutenko Lab at Penn State, birthplace of Galaxy: the open platform for accessible, reproducible computational biomedical research.">
<link rel="canonical" href="https://nekrut.github.io/lab_site/">
...
<meta property="og:url" content="https://nekrut.github.io/lab_site/">
<meta property="og:image" content="https://nekrut.github.io/lab_site/logos/galaxy.png">
...
if os.environ.get('PREVIEWS'): write('c-quiet.html', C)
if os.environ.get('PREVIEWS'): write('d-swiss.html', D_)
...
if os.environ.get('PREVIEWS'): open(f'{OUT}/previews.html', 'w').write(INDEX)
